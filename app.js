const translations = {
  en: {
    ...
    heroTitle: "Find the best deal before you choose where to go.",
    heroCopy: "Restaurants, cafes, salons, gyms, and shops publish short-lived offers when they need demand now.",
    ...
    merchantEyebrow: "Voska AI WhatsApp assistant",
    ...
    viewed: "views today",
    going: "going",
    aiIntro: "Send me a deal in plain language. Voska AI will extract the details and ask only if something required is missing.",
    confirm: "Voska AI parsed the offer. Confirm the structured preview, then publish when ready.",
  ...
  it: {
    ...
    heroTitle: "Trova l'offerta giusta prima di decidere dove andare.",
    heroCopy: "Ristoranti, cafe, saloni, palestre e negozi pubblicano offerte brevi quando hanno bisogno di clienti subito.",
    ...
    merchantEyebrow: "Assistente WhatsApp con Voska AI",
    ...
    viewed: "visite oggi",
    going: "interessati",
    aiIntro: "Mandami un'offerta in linguaggio naturale. Voska AI estrae i dettagli e chiede solo se manca qualcosa.",
    confirm: "Voska AI ha interpretato l'offerta. Controlla l'anteprima strutturata, poi pubblica quando e pronta.",
