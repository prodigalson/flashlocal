const translations = {
  en: {
    ...
    viewed: "views today",
    going: "going",
    aiIntro: "Send me a deal in plain language. I will extract the details and ask only if something required is missing.",
  ...
  it: {
    ...
    viewed: "visite oggi",
    going: "interessati",
    aiIntro: "Mandami un'offerta in linguaggio naturale. Estraggo i dettagli e chiedo solo se manca qualcosa.",
